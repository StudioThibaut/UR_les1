...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-white text-gray-900 selection:bg-red-900 selection:text-white relative overflow-x-hidden">
      ...
      <div className="max-w-350 mx-auto px-6 lg:px-12 py-12 md:py-24 space-y-12 md:space-y-24">
            ...
            <CardContent className="relative z-10 mt-4">
              <Tabs defaultValue="login" className="w-full">
                <TabsList className="grid w-full grid-cols-3 bg-white/50 p-1 rounded-xl mb-6 md:mb-8">
                  ...
                  <TabsTrigger value="forgot" className="rounded-lg data-[state=active]:bg-red-900 data-[state=active]:text-white transition-all uppercase text-[8px] md:text-[10px] font-bold tracking-widest py-2 md:py-3">Reset</TabsTrigger>
                </TabsList>
