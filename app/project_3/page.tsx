...
/* ==========================================
   ONTWERP A: JOUW EXACTE CODE (RESPONSIVE)
   ========================================== */
  ...
  <div className="animate-fadeIn">
    ...
    <div className="max-w-[1400px] mx-auto px-6 lg:px-12 py-12 md:py-24 space-y-16 md:space-y-32">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16">
        <div className="lg:col-span-8 space-y-12 md:space-y-16 text-gray-600 font-light leading-relaxed text-base md:text-lg">
          <div className="space-y-4 md:space-y-6">
            <div className="flex items-center gap-4 text-red-900"><Rocket size={24} /><h2 className="text-xl md:text-2xl font-bold uppercase tracking-tighter">Brand Concept</h2></div>
            <p>
          ...
          <div className="space-y-4 md:space-y-6">
            <div className="flex items-center gap-4 text-red-900"><Package size={24} /><h2 className="text-xl md:text-2xl font-bold uppercase tracking-tighter">Packaging & Product Design</h2></div>
            <p>
          ...
          <div className="space-y-4 md:space-y-6">
            <div className="flex items-center gap-4 text-red-900"><Target size={24} /><h2 className="text-xl md:text-2xl font-bold uppercase tracking-tighter">Marketing & Advertising</h2></div>
            <p>
        ...
        <aside className="lg:col-span-4 space-y-8">
          <div className="bg-gray-50 p-6 md:p-10 rounded-2xl md:rounded-[2.5rem] border border-gray-100 shadow-sm lg:sticky lg:top-24">
            <h3 className="font-bold text-red-900 mb-6 md:mb-8 text-xs md:text-sm tracking-[0.3em] uppercase border-b border-red-900/10 pb-4">Merk Pilaren</h3>
            <ul className="space-y-4 md:space-y-6 font-medium text-gray-900 uppercase tracking-tighter text-lg md:text-xl italic">
              <li className="flex justify-between items-center border-b border-gray-100 pb-2"><span>Snelheid</span> <span className="text-red-900/40 text-[10px] font-black">VS</span> <span>Controle</span></li>
              <li className="flex justify-between items-center border-b border-gray-100 pb-2"><span>Rauw</span> <span className="text-red-900/40 text-[10px] font-black">VS</span> <span>Premium</span></li>
              <li className="flex justify-between items-center border-b border-gray-100 pb-2"><span>Impact</span> <span className="text-red-900/40 text-[10px] font-black">VS</span> <span>Minimalisme</span></li>
              <li className="flex justify-between items-center pb-2"><span>Digitaal</span> <span className="text-red-900/40 text-[10px] font-black">VS</span> <span>Fysiek</span></li>
            </ul>
            <div className="mt-8 md:mt-12 space-y-4">
              <h4 className="text-red-900 font-bold uppercase text-[10px] tracking-widest">Design Assets</h4>
              <p className="text-xs md:text-sm text-gray-500 font-light">• Custom Typografie<br />• 3D Product Mockups<br />• Brand Styleguide<br /><span className="text-red-900/60 mt-2 block italic">Tools: Illustrator, Dimension, Photoshop</span></p>
            </div>
          </div>
        </aside>
      </section>
      ...
      <section className="space-y-6">
        <div className="relative w-full aspect-[4/3] md:aspect-[21/9] rounded-xl md:rounded-[2rem] overflow-hidden shadow-2xl border border-gray-100 cursor-zoom-in group" onClick={() => setLightboxImage("/IMG/Ignition3.jpg")}>
        ...
        <p className="text-center text-gray-400 text-[10px] md:text-xs uppercase tracking-[0.3em]">Presentatie van de merkidentiteit en packaging</p>
      </section>
    </div>
  </div>
)
...
/* ==========================================
   ONTWERP B: INDUSTRIAL WHITE (RESPONSIVE)
   ========================================== */
  ...
  <div className="animate-fadeIn bg-[#ffffff] min-h-screen text-[#1a1a1a] font-mono selection:bg-yellow-400 selection:text-black">
    ...
    <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-12 md:py-24 relative">
      <header className="mb-20 md:mb-48 border-l-[8px] md:border-l-[12px] border-black pl-6 md:pl-10">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-black uppercase leading-[0.85] tracking-tighter text-black mb-6 md:mb-10 break-words">{title}</h1>
        <div className="inline-block bg-yellow-400 px-3 py-1 md:px-4 md:py-2 text-sm sm:text-xl lg:text-2xl font-black uppercase italic leading-tight">
          "Ontstoken door adrenaline."
        </div>
        <p className="mt-4 text-black/60 text-xs sm:text-base font-bold uppercase tracking-tight">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-24 mb-20 md:mb-32">
        <div className="lg:col-span-8 space-y-20 md:space-y-32">
          <section className="space-y-6 md:space-y-10">
            <div className="text-black font-black text-[10px] md:text-xs tracking-[0.5em] uppercase border-b-4 border-black inline-block pb-1">Concept</div>
            <h2 className="text-2xl md:text-4xl font-black uppercase tracking-tighter">Brand Concept</h2>
          ...
          <section className="space-y-6 md:space-y-10">
            <div className="text-black font-black text-[10px] md:text-xs tracking-[0.5em] uppercase border-b-4 border-black inline-block pb-1">Packaging</div>
            <h2 className="text-2xl md:text-4xl font-black uppercase tracking-tighter">Packaging & Product Design</h2>
            <div className="space-y-6 md:space-y-8 text-lg md:text-xl leading-relaxed font-sans opacity-80 border-l-2 border-black/10 pl-6 md:pl-8">
          ...
          <section className="space-y-6 md:space-y-10">
            <div className="text-black font-black text-[10px] md:text-xs tracking-[0.5em] uppercase border-b-4 border-black inline-block pb-1">Advertising</div>
            <h2 className="text-2xl md:text-4xl font-black uppercase tracking-tighter italic">Marketing & Advertising</h2>
        ...
        <aside className="lg:col-span-4">
          <div className="lg:sticky lg:top-12 space-y-8 md:space-y-10">
            <div className="bg-black p-6 md:p-10 text-white shadow-2xl">
              <h3 className="font-black uppercase text-[10px] md:text-xs tracking-[0.4em] mb-6 md:mb-8 border-b-2 border-white/20 pb-4">Merk_Pilaren</h3>
              <div className="space-y-4 md:space-y-6 font-black uppercase text-xl md:text-2xl italic tracking-tighter">
                {[
                  ...
                  <div key={left} className="flex justify-between border-b border-white/10 pb-2">
                    <span className="text-yellow-400">{left}</span> <span className="opacity-20 text-[10px] md:text-xs">VS</span> <span>{right}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white p-6 md:p-8 border-4 border-black space-y-6">
              <div>
                <p className="font-black text-[10px] tracking-widest uppercase mb-1 border-b border-black pb-1">Project</p>
                <p className="text-black font-black text-lg md:text-xl italic uppercase">Ignition Energy</p>
              </div>
              <div>
                <p className="font-black text-[10px] tracking-widest uppercase mb-1 border-b border-black pb-1">Specificaties</p>
                <p className="text-black text-[10px] md:text-sm font-bold uppercase italic leading-tight">Brand Identity / Packaging<br />Print & 3D Mockups</p>
              </div>
              <div>
                <p className="font-black text-[10px] tracking-widest uppercase mb-1 border-b border-black pb-1">Tools</p>
                <p className="text-black text-[10px] md:text-sm font-bold uppercase">• Custom Typografie<br />• 3D Product Mockups<br />• Illustrator, Dimension, PSD</p>
              </div>
            </div>
          </div>
        </aside>
      ...
      <section className="mb-20 md:mb-32 space-y-6 md:space-y-8">
        ...
        <div className="relative w-full aspect-[4/3] md:aspect-[21/9] border-[6px] md:border-[12px] border-black overflow-hidden group cursor-zoom-in" onClick={() => setLightboxImage("/IMG/Ignition3.jpg")}>
...
export default function EnergyDrinkPage() {
  ...
  return (
    <main className="min-h-screen bg-white relative pb-24 md:pb-0">
      {/* Design Switcher - Responsive width */}
      <div className="fixed bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 z-[300] flex bg-black/90 backdrop-blur-xl p-1 md:p-1.5 rounded-2xl border border-white/20 shadow-2xl transition-all hover:scale-105 w-[280px] md:w-auto">
        <button onClick={() => setActiveDesign('A')} className={`flex-1 md:flex-none px-4 md:px-8 py-3 rounded-xl text-[9px] md:text-[10px] font-black tracking-widest uppercase transition-all ${activeDesign === 'A' ? 'bg-red-900 text-white shadow-lg' : 'text-white/40 hover:text-white'}`}>Design 1</button>
        <button onClick={() => setActiveDesign('B')} className={`flex-1 md:flex-none px-4 md:px-8 py-3 rounded-xl text-[9px] md:text-[10px] font-black tracking-widest uppercase transition-all ${activeDesign === 'B' ? 'bg-yellow-400 text-black shadow-lg' : 'text-white/40 hover:text-white'}`}>Design 2</button>
      </div>
      ...
      {/* Lightbox - Tap target optimization */}
      {lightboxImage && (
